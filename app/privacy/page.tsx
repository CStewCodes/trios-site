  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
      ...
      <div className="mt-8 space-y-5 text-sm text-muted">
        ...
        <p>
          Depending on how you use TriOS (marketing site vs. staging app), we may process contact
          details you submit, basic usage analytics, and training-related data you choose to import
          into the app. We do not sell personal data.
        </p>
        ...
        <p>
          Hosting and infrastructure providers (for example Vercel) may process data as needed to
          run the site and app. Planned device integrations (Garmin, Strava, Apple Health) — when
          enabled — will only connect with your explicit authorization.
        </p>
